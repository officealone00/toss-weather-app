...
import { AD_CONFIG, showInterstitialThenNavigate } from '@/lib/ads';
  ...
  return (
    <div style={styles.container}>
      <div style={{ padding: '0 20px', paddingTop: 'calc(var(--safe-top) + 16px)', paddingBottom: 'calc(var(--safe-bottom) + 24px)' }}>
          ...
          <div className="animate-in">
            ...
            {airData && (
              <div style={{ ...styles.card, marginTop: 10, display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer' }}
                onClick={() => showInterstitialThenNavigate(() => {
        ...
        {/* ── 배너 광고 ─────────── */}
        <BannerAd adGroupId={AD_CONFIG.BANNER_TOP_ID} />
        {/* 개발 중 광고 영역 확인용 (devMode={true}로 변경) */}
        <BannerAdPlaceholder label="배너 광고 ①" devMode={true} />
        ...
        {/* ── 배너 광고 ② ─────────── */}
        <BannerAd adGroupId={AD_CONFIG.BANNER_BOTTOM_ID} />
        <BannerAdPlaceholder label="배너 광고 ②" devMode={true} />
